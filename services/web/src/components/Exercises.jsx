            ...
            <div>
                ...
                <div className="field is-grouped">
                    { this.state.showButtons.prev &&
                        <button className="button is-info" onClick={() => this.prevExercise()}>&lt; Prev</button>
                    }
                    &nbsp;
                    { this.state.showButtons.next &&
                        <button className="button is-info" onClick={() => this.nextExercise()}>Next &gt;</button>
                    }
                </div>
            </div>
        )
