...
e2e() {
    ...
    ./node_modules/.bin/cypress run --config baseUrl=http://localhost --env REACT_APP_API_GATEWAY_URL=$REACT_APP_API_GATEWAY_URL,LOAD_BALANCER_STAGING_DNS_NAME=$LOAD_BALANCER_STAGING_DNS_NAME
    inspect $? e2e
